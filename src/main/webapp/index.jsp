<%@ page import="com.example.studentLessons.model.Student" %>
...
<div id="logreg-forms">
    ...
    <form action="/login" method="post" class="form-reset">
    ...
    <form action="/register" method="post" class="form-signup">
        ...
        <input type="text" id="user-pass"name="email" class="form-control" placeholder="surname" required autofocus="">
